...
class setting_config:
    ...
    def add_argument_config(cls):
        parser = argparse.ArgumentParser(description='GEMAMamba')
        ...
        if args.work_dir is None:
            args.work_dir = '/home/nihongyou/outputs/GEMAMamba/' + args.datasets_name + '/' + datetime.now().strftime(
                '%Y_%B_%d_%Hh_%Mm') + '/'
    ...
    def set_datasets(cls):
        if cls.datasets_name == 'isic2017':
            cls.data_path = '/home/nihongyou/data/ISIC2017/'
            cls.datasets = isic_loader
            cls.criterion = BceDiceLoss(0.3, 0.7)
        elif cls.datasets_name == 'isic2018':
            cls.data_path = '/home/nihongyou/data/ISIC2018/'
            cls.datasets = isic_loader
            cls.criterion = BceDiceLoss(0.3, 0.7)
        elif cls.datasets_name == 'acdc':
            cls.data_path = '/home/nihongyou/data/ACDC/'
            cls.datasets = ACDC_dataset
            cls.list_dir = '/home/nihongyou/projects/GEMAMamba-main/lists/lists_ACDC/'
            cls.volume_path = '/home/nihongyou/data/ACDC/test'
            cls.model_config['num_classes'] = 4
            cls.criterion = CeDiceLoss(4, cls.loss_weight)
        elif cls.datasets_name == 'lidc':
            cls.data_path = '/home/nihongyou/data/LIDC_IDRI/'
            cls.datasets = LIDCROIDataset
            cls.list_dir = '/home/nihongyou/projects/GEMAMamba-main/lists/lists_LIDC/'
            cls.model_config['num_classes'] = 2
            cls.model_config['input_channels'] = 1
            cls.input_size_h = 256
            cls.input_size_w = 256
            cls.criterion = CeDiceLoss(2, cls.loss_weight)
        else:
    ...
    @classmethod
    def set_opt_sch(cls):
        assert cls.opt in ['Adadelta', 'Adagrad', 'Adam', 'AdamW', 'Adamax', 'ASGD', 'RMSprop', 'Rprop',
                           'SGD'], 'Unsupported optimizer!'
        if cls.opt == 'Adadelta':
            cls.lr = 0.01 if not hasattr(cls,
                                         'lr') else cls.lr  # default: 1.0 – coefficient that scale delta before it is applied to the parameters
